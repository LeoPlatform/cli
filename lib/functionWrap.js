...
module.exports = function( /*options*/ ) {
	...
	return {
		express: function(name, opts) {
			const testConfig = require("leo-config/lib/build").dynamicBuild(name);
			return function(req, res) {
				...
				var user = {};
				if (testConfig.leoauth.test && testConfig.leoauth.test.personas) {
					user = testConfig.leoauth.test.personas[testConfig.leoauth.test.defaultPersona || 'default'];
				}
				var event = {
					"body": req.body,
					headers: req.headers,
