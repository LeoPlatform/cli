...
module.exports = function( /*options*/ ) {
	...
	let testProcess = path.resolve(configure && configure._meta && configure._meta.microserviceDir, "test/process.json");
	let testProcessJs = path.resolve(configure && configure._meta && configure._meta.microserviceDir, "test/process.json");
	let processConfig = {};
	try {
