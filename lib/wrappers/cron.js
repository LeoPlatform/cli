...
var config = require("../../leoConfigure");
var async = require("async");

var leosdk = require("../../index");
var kms = require("../kms")(leosdk.configuration);
const refUtil = require("../reference.js");


process.__config = config;
var fill = require("../build-config").fillWithTableReferences;
	...
	handler: function(event, context, callback) {
		...
		if (event.requestContext) { //new lambda proxy method
			if (event.isBase64Encoded) {
				event.body = JSON.parse(Buffer.from(event.body, 'base64'));
			} else {
