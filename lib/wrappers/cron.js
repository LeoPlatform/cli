...
let leosdkconfig = require('leo-sdk/lib/leo-sdk-config');

if (!config.defaultProfile && leoconfig['leo-sdk']) {
	leosdkconfig.default = leoconfig['leo-sdk'];
} else if (!config.defaultProfile && leoconfig['leosdk']) {
	leosdkconfig.default = leoconfig['leosdk'];
}
