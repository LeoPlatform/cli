  ...
  if(['${p.join("','")}'].indexOf(page) !== -1) {
    fs.readFile("./pages/"+page, 'utf8', function (err, data) {
      ...
      if (process.resources.CustomFavicon){
        replacements[\`<link rel="icon" href="//cdnleo.s3.amazonaws.com/logos/leo_icon.png" type="image/png" />\`]          = \`<link rel="icon" href="\${process.resources.CustomFavicon}" type="image/png" />\`;
        replacements[\`<link rel="shortcut icon" href="//cdnleo.s3.amazonaws.com/logos/leo_icon.png" type="image/png" />\`] = \`<link rel="shortcut icon" href="\${process.resources.CustomFavicon}" type="image/png" />\`;
      }
